...
<body>
    <div bgcolor="#323232">
        ...
        <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
         ...
         <a href="https://www.{{ env('APP_NAME') }}" target="_blank">
         <img src="{{ env("EMAIL_LOGO") }}" alt="{{ env('APP_NAME') }}" border="0" style="display:block; width:100px" class="CToWUd">
         </a>
         </a>
         </td>
         ...
         <p><strong>{{ env("SITE_NAME") }}</strong> wants to verify that you are the owner of this email before your password can be reset.</p>
        <p>
         Password reset token: <span style="color:red;font-weight:bold">{{ $details["token"] }}</span>.
        </p>
        <p>
            Your {{ env("SITE_SHORT_NAME") }} Username is: <span style="color:red;font-weight:bold">{{ $details['username'] }}</span>.
           </p>
        <p>
            You can now reset your {{ env("SITE_SHORT_NAME") }} password.
        ...
        <div style="padding:0px 0px 25px 0px">
         ...
         <br><br>
         To start investing with EG, you must create session with us, and to do that, you must login. <br>
         </td>
         </tr>
         </tbody></table>
        </div>
        
        <a href="https://www.{{ env('APP_NAME') }}/login" style="color:#ffffff;text-decoration:none" target="_blank">
        ...
        <a href="https://www.{{ env('APP_NAME') }}/deposit" style="color:#ffffff;text-decoration:none" target="_blank">
            <div align="center" style="width:400px;background-color:#d50002;border-radius:5px;text-align:center;padding:10px 20px;color:#ffffff;font-size:16px;font-weight:bold;margin:auto">
        ...
        <a href="https://www.{{ env('APP_NAME') }}/withdraw" style="color:#ffffff;text-decoration:none" target="_blank">
            <div align="center" style="width:400px;background-color:#d50002;border-radius:5px;text-align:center;padding:10px 20px;color:#ffffff;font-size:16px;font-weight:bold;margin:auto">
        ...
        <strong>© {{ date('Y') }} EG. All rights reserved.</strong>
        <br><br>
        ...
        <img src="https://ci3.googleusercontent.com/proxy/NS_eWBZ38sib0l_KTTAE9qVYDWGZpXPm1nCg7IMmWKe3qxs_w87P0YEezrFM9gCs17ThY1gjnJ8dlm6UQEvqLP6W5w4PCdo2beyHoi3fOov9_AyBiRQB_heBf63MHLqD8u7OHP_4q4SaWm3tQVX3oWnJ2h9G80Jdo8Z94Lvs3zSjm_p-zh1y4KbXsv47SeFANQHLzE4GmZZNIMD6HH5joxerCnQ_Fkhj6htdFKhq78a0S15e7Gw92EcsIVmiyQsliFeIhSwQP8UnQsWFnrGAW7AoCTNz5Pa0_Z39c5i3-KoWGTgPKM8OJf3F0IUVEZGGpQyZ2jIJztWxzFhhv_yG8VpCQx-kznrJmSXXz75NJN7vVMfpFZ5VxnS31xczIgkZYmdin95MFYXYNFrtqimvS5it=s0-d-e1-ft#http://email.{{ env('APP_NAME') }}/wf/open?upn=b5NRcAX-2BuEuTGJRk-2F9OpuKfrKYmj5hV-2Fn6N9joNM2c6Puv4hTm6b12dacE1iNBxY8nMVvxiEspeBYvqpAfz-2F2VK2mqxZkC8yXyp8IcNfpGOsVhlBTPFh8GG-2B6LM2Gn5EP8ZtWuDDZp89Ex-2FUufFBSS5XMLrJwn8U603mIsSjzDBe3wKbZfIbGH-2F85v3cbatkk-2Bu7N1VapN9ptW199LmQHBsQysn7Zlwc8cneGfGa9dQ-3D" alt="" width="1" height="1" border="0" style="height:1px!important;width:1px!important;border-width:0!important;margin-top:0!important;margin-bottom:0!important;margin-right:0!important;margin-left:0!important;padding-top:0!important;padding-bottom:0!important;padding-right:0!important;padding-left:0!important" class="CToWUd"></div>
</body>
</html>