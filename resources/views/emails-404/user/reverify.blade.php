...
<body>
    <div bgcolor="#323232">
        ...
        <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
         ...
         <p><strong>{{ env("SITE_NAME") }}</strong> wants to reverify that you are the owner of this email.</p>
        <p>
        Verification Token: <span style="color:red;font-weight:bold">{{ $details["token"] }}</span>.
        </p>
        <p>
