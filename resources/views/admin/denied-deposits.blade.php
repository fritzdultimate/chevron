            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-dark">Denied Deposits</h3>
                    </div>
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Admin</a></li>
                            <li class="breadcrumb-item active">Denied Deposits</li>
                        </ol>
                    </div>
                </div>
                                        ...
                                        <table id="record-table" class="display record-table record-export nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $deposit->reinvestment ? 'Deposit' : 'Reinvestment' }}</td>
                                                    <td>{{ isset($deposit->plan_name) ? $deposit->plan_name : 'null' }}</td>
                                                    <td>{{ $deposit->wallet->currency }}</td>
                                                    <td>${{ number_format($deposit['amount'], 2)  }}</td>
                                                    <td>{{ $deposit['transaction_hash'] }}</td>
                                                    <td>
                                                        <span class="badge badge-danger text-dark badge-pill px-2 py-1"> {{ $deposit['status'] }} </span>
                                                    </td>
