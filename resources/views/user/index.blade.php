            ...
            <div class="account_wrapper pt-lg-5 mt-lg-5 float_left">
                ...
                <div class="row" style="margin-bottom: 3px">
                    <div class="col-12 text-light">
                        <img style="width: 100%; height: 150px; padding:0px;" src="{{ asset('images/success2.png') }}">
                    </div>
                </div>
                <br>
                <div class="row">
                    ...
                    <div class="col-12">
                        <div style="background:#053b50" class="p-3">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" id="clip-input" class="clip-input form-control"  value="{{ request()->getSchemeAndHttpHost() }}/signup?ref={{ $user['name'] }}">
