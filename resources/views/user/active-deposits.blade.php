            ...
            <div class="page-wrapper">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-dark">Active Deposits</h3>
                    </div>
                    <div class="col-md-7 align-self-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">User</a></li>
                            <li class="breadcrumb-item active">Active Deposits</li>
                        </ol>
                    </div>
                </div>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <form action="" method="POST">
                                                                    ...
                                                                    <button type="submit" data-action="delete" data-id="{{ $deposit['id'] }}" class="dropdown-item" href="#">Pause</button>
                                                                </form>
                                                            </div>
                                                        </div>
                                                    </td>
