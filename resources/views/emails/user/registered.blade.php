                                                ...
                                                <tr>
                                                    <td>
                                                        <table style="width:100%">
                                                            <tbody>
                                                                <tr>
                                                                    <td width="30%" height="80" bgcolor="#000000"
                                                                        style="padding-left:20px;text-align:left">
                                                                        <a href="https://www.{{ env('APP_NAME') }}"
                                                                            target="_blank">
                                                                            <img src="{{ env(" EMAIL_LOGO") }}"
                                                                                alt="{{ env('APP_NAME') }}"
                                                                    ...
                                                                    <td width="30%" height="80" align="right"
                                                                        bgcolor="#000000" style="padding-right:20px">
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                    ...
                                    <td width="650" bgcolor="#ffffff" style="padding:40px 0 30px">
                                        <table width="650" border="0" cellspacing="0" cellpadding="0">
                                            <tbody>
                                                <tr>
                                                    <td width="30"></td>
                                                    <td width="590" align="left" dir="ltr"
                                                        style="font-family:Arial,Helvetica,sans-serif;color:#000000;font-size:14px">

                                                        <p>
                                                            Dear {{ ucfirst($details['username']) }}</span>.
                                                        </p>
                                                        <p>
                                                            Thank you for choosing <strong>{{ env("SITE_NAME")
                                                                }}</strong>.
                                                        <p>
                                                        <p>
                                                        ...
                                                        <br><br>
                                                        <div
                                                            style="padding:0 0 20px;font-size:20px;font-weight:bold;color:#e41824">
                                                            Your Account Details 
                                                        </div>
                                                       
                                                        Your {{ env("SITE_SHORT_NAME") }} ID is: <span
                                                            style="color:red;font-weight:bold">{{
                                                            ucfirst($details['uid']) }}</span>.
                                                        <br>
                                                        Your {{ env("SITE_SHORT_NAME") }} Username is: <span
                                                            style="color:red;font-weight:bold">{{
                                                            ucfirst($details['username']) }}</span>.
                                                        <br>
                                                    </td>
                                                    <td width="30"></td>
                                                </tr>
                        ...
                        <table width="650" border="0" cellspacing="0" cellpadding="0">
                            <tbody>
                                <tr>
                                    ...
                                    <td width="590" bgcolor="#f5f5f5" align="left"
                                        style="font-family:Arial,Helvetica,sans-serif;color:#000000;font-size:14px;padding:25px 0"
                                        dir="ltr">
                                        <strong>© {{ date("Y") }} CR. All rights reserved.</strong>
                                        <br><br>
                                        <strong>Legal:</strong> {{ env("SITE_NAME") }} Limited is authorised and
                                        regulated by the International Financial Services Commission (IFSC) (license
                                        number 000261/158).<br><br>
                                    </td>
                                    <td width="30" bgcolor="#f5f5f5"></td>
                                </tr>
                            </tbody>
                            ...
                            <tbody>
                                <tr>
                                    <td width="650" height="30" align="center" bgcolor="#000000"
                                        style="font-family:Arial,Helvetica,sans-serif;color:#656565;font-size:10px">
