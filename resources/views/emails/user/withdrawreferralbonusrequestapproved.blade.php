...
<body>
    <div bgcolor="#323232">
        ...
        <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
         ...
         <p> <strong>Empress Globe</strong> has approved your withdrawal request and your provided wallet address funded.</p>
            
            <p>
                Username: <span style="color:red;font-weight:bold">{{ ucfirst($details['username']) }}</span>.
            </p>
            <p>
        ...
        <p>
           Keep your account safe from third parties.
        </p>
         </td>
         <td width="30"></td>
         </tr>
