...
<div class="Content" data-v-e58086ca="">
    <div class="wrap" data-v-e58086ca="">
        <h2 class="pub_banner_tit" data-v-e58086ca="">Privacy Policy</h2>
        {{-- <p class="font_16_reg" data-v-e58086ca="">Regulated &amp; Secured Trading Platform.</p> --}}
        <div class="col-md-8 col-12" style="float:none">
            <br>
            {{-- <h1 class="fw-bold">Privacy Policy</h1> --}}
            <p>Updated at 2023-10-13</p>

            <p> {{ env('APP_NAME') }} (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by {{ env('APP_NAME') }}.</p>
            <p>This Privacy Policy applies to our website, and its associated subdomains (collectively, our “Service”) alongside our application, {{ env('APP_NAME') }}. By accessing or using our Service, you signify that you have read, understood, and agree to our collection, storage, use, and disclosure of your personal information as described in this Privacy Policy and our Terms of Service. </p>
            ...
            <li class="py-1"><b>Cookie:</b> &nbsp;small amount of data generated by a website and saved by your web browser. It is used to identify your browser, provide analytics, remember information about you such as your language preference or login information.</li>
            <li class="py-1"><b>Company:</b> when this policy mentions “Company,” “we,” “us,” or “our,” it refers to {{ env('APP_NAME') }} that is responsible for your information under this Privacy Policy.</li>
            <li class="py-1"><b>Country:</b> where {{ env('APP_NAME') }} or the owners/founders of {{ env('APP_NAME') }} are based, in this case is USA</li>
            <li class="py-1"><b>Customer:</b>&nbsp;refers to the company, organization or person that signs up to use the {{ env('APP_NAME') }} Service to manage the relationships with your consumers or service users.</li>
            <li class="py-1"><b>Device:</b>&nbsp;any internet connected device such as a phone, tablet, computer or any other device that can be used to visit {{ env('APP_NAME') }} and use the services.</li>
            <li class="py-1"><b>IP address:</b> Every device connected to the Internet is assigned a number known as an Internet protocol (IP) address. These numbers are usually assigned in geographic blocks. An IP address can often be used to identify the location from which a device is connecting to the Internet.</li>
            <li class="py-1"><b>Personnel:</b>&nbsp;refers to those individuals who are employed by {{ env('APP_NAME') }} or are under contract to perform a service on behalf of one of the parties.</li>
            <li class="py-1"><b>Personal Data:</b> any information that directly, indirectly, or in connection with other information — including a personal identification number — allows for the identification or identifiability of a natural person.</li>
            <li class="py-1"><b>Service:</b> refers to the service provided by {{ env('APP_NAME') }} as described in the relative terms (if available) and on this platform.</li>
            <li class="py-1"><b>Third-party service:</b>&nbsp;refers to advertisers, contest sponsors, promotional and marketing partners, and others who provide our content or whose products or services we think may interest you.</li>
            <li class="py-1"><b>Website:</b> {{ env('APP_NAME') }}'s site, which can be accessed via this URL: {{ env('APP_NAME') }}</li>
            <li class="py-1"><b>You:</b> a person or entity that is registered with {{ env('APP_NAME') }} to use the Services.</li>
            </ul>
            <p></p>
            <br>
            <h1 class="fw-bold">What Information Do We Collect?</h1>
            ...
            <br>
            <h1 class="fw-bold">How Do We Use The Information We Collect?</h1>
            ...
            <br>
            <h1 class="fw-bold">When does {{ env('APP_NAME') }} use end user information from third parties?</h1>
            <p>{{ env('APP_NAME') }} will collect End User Data necessary to provide the {{ env('APP_NAME') }} services to our customers.</p>
            ...
            <br>
            <h1 class="fw-bold">When does {{ env('APP_NAME') }} use customer information from third parties?</h1>
            <p>We receive some information from the third parties when you contact us. For example, when you submit your email address to us to show interest in becoming a {{ env('APP_NAME') }} customer, we receive information from a third party that provides automated fraud detection services to {{ env('APP_NAME') }}. We also occasionally collect information that is made publicly available on social media websites. You can control how much of your information social media websites make public by visiting these websites and changing your privacy settings.</p>

            <br>
            <h1 class="fw-bold">Do we share the information we collect with third parties?</h1>
            ...
            <br>
            <h1 class="fw-bold">Where and when is information collected from customers and end users?</h1>
            <p>{{ env('APP_NAME') }} will collect personal information that you submit to us. We may also receive personal information about you from third parties as described above.</p>

            <br>
            <h1 class="fw-bold">How Do We Use Your Email Address?</h1>
            ...
            <br>
            <h1 class="fw-bold">How Long Do We Keep Your Information?</h1>
            <p>We keep your information only so long as we need it to provide {{ env('APP_NAME') }} to you and fulfill the purposes described in this policy. This is also the case for anyone that we share your information with and who carries out services on our behalf. When we no longer need to use your information and there is no need for us to keep it to comply with our legal or regulatory obligations, we’ll either remove it from our systems or depersonalize it so that we can't identify you.</p>

            <br>
            <h1 class="fw-bold">How Do We Protect Your Information?</h1>
            <p>We implement a variety of security measures to maintain the safety of your personal information when you place an order or enter, submit, or access your personal information. We offer the use of a secure server. All supplied sensitive/credit information is transmitted via Secure Socket Layer (SSL) technology and then encrypted into our Payment gateway providers database only to be accessible by those authorized with special access rights to such systems, and are required to keep the information confidential. After a transaction, your private information (credit cards, social security numbers, financials, etc.) is never kept on file. We cannot, however, ensure or warrant the absolute security of any information you transmit to {{ env('APP_NAME') }} or guarantee that your information on the Service may not be accessed, disclosed, altered, or destroyed by a breach of any of our physical, technical, or managerial safeguards.</p>

            <br>
            <h1 class="fw-bold">Could my information be transferred to other countries?</h1>
            <p>{{ env('APP_NAME') }} is incorporated in USA. Information collected via our website, through direct interactions with you, or from use of our help services may be transferred from time to time to our offices or personnel, or to third parties, located throughout the world, and may be viewed and hosted anywhere in the world, including countries that may not have laws of general applicability regulating the use and transfer of such data. To the fullest extent allowed by applicable law, by using any of the above, you voluntarily consent to the trans-border transfer and hosting of such information.</p>

            <br>
            <h1 class="fw-bold">Is the information collected through the {{ env('APP_NAME') }} Service secure?</h1>
            ...
            <br>
            <h1 class="fw-bold">Can I update or correct my information?</h1>
            <p>The rights you have to request updates or corrections to the information {{ env('APP_NAME') }} collects depend on your relationship with {{ env('APP_NAME') }}. Personnel may update or correct their information as detailed in our internal company employment policies.</p>
            ...
            <br>
            <h1 class="fw-bold">Personnel</h1>
            <p>If you are a {{ env('APP_NAME') }} worker or applicant, we collect information you voluntarily provide to us. We use the information collected for Human Resources purposes in order to administer benefits to workers and screen applicants.</p>
            ...
            <br>
            <h1 class="fw-bold">Sale of Business</h1>
            <p>We reserve the right to transfer information to a third party in the event of a sale, merger or other transfer of all or substantially all of the assets of {{ env('APP_NAME') }} or any of its Corporate Affiliates (as defined herein), or that portion of {{ env('APP_NAME') }} or any of its Corporate Affiliates to which the Service relates, or in the event that we discontinue our business or file a petition or have filed against us a petition in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere to the terms of this Privacy Policy.</p>

            <br>
            <h1 class="fw-bold">Affiliates</h1>
            <p>We may disclose information (including personal information) about you to our Corporate Affiliates. For purposes of this Privacy Policy, "Corporate Affiliate" means any person or entity which directly or indirectly controls, is controlled by or is under common control with {{ env('APP_NAME') }}, whether by ownership or otherwise. Any information relating to you that we provide to our Corporate Affiliates will be treated by those Corporate Affiliates in accordance with the terms of this Privacy Policy.</p>

            <br>
            <h1 class="fw-bold">Governing Law</h1>
            <p>This Privacy Policy is governed by the laws of USA without regard to its conflict of laws provision. You consent to the exclusive jurisdiction of the courts in connection with any action or dispute arising between the parties under or in connection with this Privacy Policy except for those individuals who may have rights to make claims under Privacy Shield, or the Swiss-US framework.</p>
            <p>The laws of USA, excluding its conflicts of law rules, shall govern this Agreement and your use of the website. Your use of the website may also be subject to other local, state, national, or international laws.</p>
            <p>By using {{ env('APP_NAME') }} or contacting us directly, you signify your acceptance of this Privacy Policy. If you do not agree to this Privacy Policy, you should not engage with our website, or use our services. Continued use of the website, direct engagement with us, or following the posting of changes to this Privacy Policy that do not significantly affect the use or disclosure of your personal information will mean that you accept those changes.</p>
            ...
            <p>This Privacy Policy applies only to the Services. The Services may contain links to other websites not operated or controlled by {{ env('APP_NAME') }}. We are not responsible for the content, accuracy or opinions expressed in such websites, and such websites are not investigated, monitored or checked for accuracy or completeness by us. Please remember that when you use a link to go from the Services to another website, our Privacy Policy is no longer in effect. Your browsing and interaction on any other website, including those that have a link on our platform, is subject to that website’s own rules and policies. Such third parties may use their own cookies or other methods to collect information about you.</p>
            <br>
            ...
            <br>
            <h1 class="fw-bold">Blocking and disabling cookies and similar technologies</h1>
            ...
            <br>
            <h1 class="fw-bold">Remarketing Services</h1>
            ...
            <br>
            <h1 class="fw-bold">Kids' Privacy</h1>
            ...
            <br>
            <h1 class="fw-bold">Changes To Our Privacy Policy</h1>
            ...
            <br>
            <h1 class="fw-bold">Tracking Technologies</h1>
            ...
            <p>Google Maps API collects information that is held in accordance with its Privacy Policy</p></li><br><li>Cookies
            <br><br>
            ...
            <br>
            <h1 class="fw-bold">Information about General Data Protection Regulation (GDPR)</h1>
            ...
            <br>
            <h1 class="fw-bold">What is GDPR?</h1>
            ...
            <br>
            <h1 class="fw-bold">What is personal data?</h1>
            ...
            <br>
            <h1 class="fw-bold">Why is GDPR important?</h1>
            <p>GDPR adds some new requirements regarding how companies should protect individuals' personal data that they collect and process. It also raises the stakes for compliance by increasing enforcement and imposing greater fines for breach. Beyond these facts it's simply the right thing to do. At {{ env('APP_NAME') }} we strongly believe that your data privacy is very important and we already have solid security and privacy practices in place that go beyond the requirements of this new regulation.</p>

            <br>
            <h1 class="fw-bold">Individual Data Subject's Rights - Data Access, Portability and Deletion</h1>
            <p>We are committed to helping our customers meet the&nbsp;data subject rights requirements of GDPR. {{ env('APP_NAME') }} processes or stores all personal data in fully vetted, DPA compliant vendors. We do store all conversation and personal data for up to 6 years unless your account is deleted. In which case, we dispose of all data in accordance with our Terms of Service and Privacy Policy, but we will not hold it longer than 60 days.</p>
            ...
            <br>
            <h1 class="fw-bold">California Residents</h1>
            ...
            <br>
            <h1 class="fw-bold">California Online Privacy Protection Act (CalOPPA)</h1>
