...
@section('content')
<div class="Content" data-v-e58086ca="">
    <div class="wrap" data-v-e58086ca="">
        <h2 class="pub_banner_tit" data-v-e58086ca="">Cookies Policy</h2>
        {{-- <p class="font_16_reg" data-v-e58086ca="">Regulated &amp; Secured Trading Platform.</p> --}}
        <div>
            <p>Our Cookies Policy was last updated on 9/12/2023.</p>
            <p>This Cookies Policy explains what Cookies are and how We use them. You should read this policy so You can
                understand
                what type of cookies We use, or the information We collect using Cookies and how that information is used. </p>
            <p>Cookies do not typically contain any information that personally identifies a user, but personal information that
                we
                store about You may be linked to the information stored in and obtained from Cookies. For further information on
                how
            ...
            <ul>
                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Cookies Policy)
                    refers to {{ env('APP_NAME') }}</li>
                ...
                <li><strong>Website</strong> refers to {{ env('APP_NAME') }}, accessible from www.{{ env('APP_NAME') }}</li>
            ...
            <ul>
                ...
                <li>
                    ...
                    <p>Purpose: These Cookies are used to track information about traffic to the Website and how users use the
                        ...
                        advertisements, pages, features or new functionality of the Website to see how our users react to them.
                    </p>
                </li>
            </ul>
            <br>
            ...
            <ul>
                <li>By sending us an email: support@{{ env('APP_NAME') }}</li>
            </ul>
            <p></p>
        </div>
    </div>
