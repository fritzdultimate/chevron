...
<html lang="en-US" data-website-id="2" data-main-object="website.page(7,)" data-country="NG" data-logged="false" data-browser="chrome,125.0.0.0">
    <head>
        <meta charset="utf-8">
        ...
        <meta property="og:url" content="https://www.{{ env('APP_NAME') }}/">
        ...
        <link rel="canonical" href="https://www.{{ env('APP_NAME') }}/">
        ...
        <link type="text/css" rel="stylesheet" href="{{ asset('assets/css/frontend.css') }}" data-asset-bundle="web.assets_frontend" data-asset-version="2c33c7e">
        ...
        <div class="row align-items-center">
            <div class="col-lg-8 o_colored_level contact_topbar_h contact_topbar">
                <small>
                    ...
                    <i class="fa fa-1x fa-fw fa-envelope me-2 d-inline"></i><a href="mailto:info@chevronrefinery.net" data-bs-original-title="" title="">info@chevronrefinery.net</a>
                </small>
            </div>
...
<span role="img" aria-label="Logo of {{ env('APP_NAME') }}" title="{{ env('APP_NAME') }}">
  <img src="{{ asset('images/logo.jpg') }}" class="img img-fluid logo_navbar" width="95" height="40" alt="{{ env('APP_NAME') }}" loading="lazy" style=""></span>
</a>
...
<ul class="dropdown-menu" role="menu">
<li class="">
<a role="menuitem" href="/health-safety-environment" class="dropdown-item " style="display: none;">
...
<span>Career in {{ env('APP_NAME') }}</span>
</a>
</li>
<li class="">
