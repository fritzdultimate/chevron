            ...
            <div class="flex_sb_cen" data-v-36ac65e2="">
                <div class="dl" data-v-36ac65e2="" style="display: contents">
                    <a href="{{ route('guest.index') }}" aria-current="page" class="logo-link nuxt-link-exact-active nuxt-link-active" data-v-36ac65e2="">
                        <img src="{{ asset('images/logo.jpg') }}" style="height:40px; width: 60px" alt="" class="logo-img logo_white" data-v-36ac65e2="" />
                        <img src="{{ asset('images/logo.jpg') }}" style="height:40px; width: 60px" alt="" class="logo-img logo_black" data-v-36ac65e2="" />
