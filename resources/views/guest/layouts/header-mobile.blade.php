    ...
    <div class="wrap" data-v-bd520568="">
        <div class="flex_sb_cen" data-v-bd520568="">
            <a href="{{ route('guest.index') }}" aria-current="page" class="logo-link nuxt-link-exact-active nuxt-link-active" data-v-bd520568="">
                <img src="{{ asset('images/logo.jpg') }}" style="height:40px; width: 60px" alt="" class="logo-img" data-v-bd520568="" /> 
                
                <img src="{{ asset('images/logo.jpg') }}" style="height:40px; width: 60px" alt="" class="logo-img-m" data-v-bd520568="" />
            </a>
