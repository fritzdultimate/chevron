                ...
                <div class="nk-block-head">
                  <div class="nk-block-head-content">
                    ...
                    <div class="nk-block-between-md g-4">
                      <div class="nk-block-head-content">
                        <h2 class="nk-block-title fw-normal">{{ ucfirst($deposit->plan_name) }} - Daily {{ $deposit->plan_interest_rate }}% for {{ $deposit->plan_duration }} Days</h2>
                                ...
                                <div class="col-md-6">
                                    <div class="nk-iv-wg3">
                                        <div class="nk-iv-wg3-group flex-lg-nowrap gx-4">
                                            <p>Please copy the below wallet address and make a deposit of exactly <strong>${{ number_format($deposit->amount) }} to {{ $deposit->nowpayment_currency }}</strong></p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-lg-4 offset-lg-2">
                          <div class="nk-iv-wg3 ps-md-3">
                            <div class="nk-iv-wg3-group flex-lg-nowrap gx-4">
                              <div class="nk-iv-wg3-sub">
                                <div class="nk-iv-wg3-amount">
                                  <div class="number">{{ number_format($deposit->amount + ((($deposit->amount/100)* $deposit->plan_interest_rate) * $deposit->plan_duration)) }} 
                                    <span class="number-up">{{ (((($deposit->amount/100)* $deposit->plan_interest_rate) * $deposit->plan_duration)* 100)/ $deposit->amount  }} %
                    ...
                    <div id="schemeDetails" class="nk-iv-scheme-details">
                      <ul class="nk-iv-wg3-list">
                        <li>
                          ...
                          <div class="lead-text">{{ $deposit->plan_duration }} Days</div>
                        </li>
                        <li>
                        ...
                        <li>
                          ...
                          <div class="lead-text">{{ get_day_format(addDaysToDate($deposit->approved_at, $deposit->plan_duration)) }}</div>
                        </li>
                        <li>
                          <div class="sub-text">Daily interest</div>
                          <div class="lead-text">{{ $deposit->plan_interest_rate }}%</div>
                        </li>
                      </ul>
                      <ul class="nk-iv-wg3-list">
                        <li>
                        ...
                        <li>
                          ...
                          <div class="lead-text">{{ ucfirst($deposit->nowpayment_currency) }}</div>
                        </li>
                        <li>
                      ...
                      <ul class="nk-iv-wg3-list">
                        ...
                        <li>
                          ...
                          <div class="lead-text">
                            <span class="currency currency-usd">USD</span> {{ number_format($deposit->amount/100 * $deposit->plan_interest_rate) }}
                          </div>
                        </li>
                        <li>
                          <div class="sub-text">Expected net profit</div>
                          <div class="lead-text">
                            <span class="currency currency-usd">USD</span> {{ number_format($deposit->amount/100 * $deposit->plan_interest_rate * $deposit->plan_duration) }}
                          </div>
                        </li>
                        <li>
                          <div class="sub-text">Total to return</div>
                          <div class="lead-text">
                            <span class="currency currency-usd">USD</span> {{ number_format($deposit->amount + $deposit->amount/100 * $deposit->plan_interest_rate * $deposit->plan_duration) }}
                          </div>
                        </li>
                      </ul>
                    </div>
                        ...
                        <div class="card-inner justify-center text-center h-100">
                          <div class="nk-iv-wg5">
                            ...
                            <div class="nk-iv-wg5-ck">
                              <input type="text" class="knob-half" value="{{ (100/$deposit->plan_duration) * ($deposit->plan_duration - $deposit->remaining_duration) }}" data-fgColor="#6576ff" data-bgColor="#d9e5f7" data-thickness=".06" data-width="300" data-height="155" data-displayInput="false">
                              <div class="nk-iv-wg5-ck-result">
                                <div class="text-lead">{{ number_format((100/$deposit->plan_duration) * ($deposit->plan_duration - $deposit->remaining_duration), 2) }}%</div>
                                <div class="text-sub">${{ number_format($deposit->amount /100 * $deposit->plan_interest_rate) }} / per day</div>
                              </div>
                              <div class="nk-iv-wg5-ck-minmax">
                                <span>{{ number_format($deposit->amount, 2) }}</span>
                                <span>{{ number_format($deposit->amount + $deposit->amount/100 * $deposit->plan_interest_rate * $deposit->plan_duration, 2) }}</span>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="card-inner justify-center text-center h-100">
                          <div class="nk-iv-wg5">
                            ...
                            <div class="nk-iv-wg5-ck sm">
                              <input type="text" class="knob-half" value="{{ (100/($deposit->amount/100 * $deposit->plan_interest_rate * $deposit->plan_duration) * $profit_sum) }}" data-fgColor="#33d895" data-bgColor="#d9e5f7" data-thickness=".07" data-width="240" data-height="125" data-displayInput="false">
                              <div class="nk-iv-wg5-ck-result">
                                <div class="text-lead sm">{{ $deposit->plan_interest_rate }}%</div>
                                <div class="text-sub">Daily profit</div>
                              </div>
                              <div class="nk-iv-wg5-ck-minmax">
                                <span>{{ number_format($profit_sum, 2) }}</span>
                                <span>{{ number_format($deposit->amount/100 * $deposit->plan_interest_rate * $deposit->plan_duration, 2) }}</span>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="card card-bordered h-100">
                        <div class="card-inner justify-center text-center h-100">
                          <div class="nk-iv-wg5">
                            ...
                            <div class="nk-iv-wg5-ck sm">
                              <input type="text" class="knob-half" value="{{ (100/($deposit->plan_duration)) * ($deposit->plan_duration - $deposit->remaining_duration) }}" data-fgColor="#816bff" data-bgColor="#d9e5f7" data-thickness=".07" data-width="240" data-height="125" data-displayInput="false">
                              <div class="nk-iv-wg5-ck-result">
                                <div class="text-lead sm">{{ $deposit->remaining_duration }} D</div>
                                <div class="text-sub">day remain</div>
                              </div>
                              <div class="nk-iv-wg5-ck-minmax">
                                <span>{{ $deposit->plan_duration - $deposit->remaining_duration }}</span>
                                <span>{{ $deposit->plan_duration }}</span>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <table class="table table-iv-tnx">
                      ...
                      <tbody>
                        ...
                        @foreach ($profits as $profit)
                            <tr>
                                <td class="tb-col-type">
                                    <span class="sub-text">Profit - {{ $deposit->plan_interest_rate }}%</span>
                                </td>
                                <td class="tb-col-date">
