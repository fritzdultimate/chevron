        ...
        <div class="nk-block invest-block">
            ...
            <div class="row g-gs">
                ...
                <div class="invest-field form-group">
                    ...
                    @php
                        $totalBalance = $user->total_balance < 500 ? 500 : $user->total_balance;
                    @endphp

                    <div class="invest-amount-group g-2">
                    <div class="invest-amount-item" data-amount="{{ (($totalBalance /100) * 10) }}">
                        <input type="radio" class="invest-amount-control" name="iv-amount" id="iv-amount-2">
                        <label class="invest-amount-label" for="iv-amount-2">$ {{ number_format((($totalBalance /100) * 10)) }}</label>
                    </div>
                    <div class="invest-amount-item" data-amount="{{ (($totalBalance /100) * 30) }}">
                        <input type="radio" class="invest-amount-control" name="iv-amount" id="iv-amount-3">
                        <label class="invest-amount-label" for="iv-amount-3">$ {{ number_format( (($totalBalance /100) * 30)) }}</label>
                    </div>
                    <div class="invest-amount-item" data-amount="{{  (($totalBalance /100) * 55) }}">
                        <input type="radio" class="invest-amount-control" name="iv-amount" id="iv-amount-4">
                        <label class="invest-amount-label" for="iv-amount-4">$ {{ number_format( (($totalBalance /100) * 55)) }}</label>
                    </div>
                    <div class="invest-amount-item" data-amount="{{  (($totalBalance /100) * 70) }}">
                        <input type="radio" class="invest-amount-control" name="iv-amount" id="iv-amount-5">
                        <label class="invest-amount-label" for="iv-amount-5">$ {{ number_format( (($totalBalance /100) * 70)) }}</label>
                    </div>
                    <div class="invest-amount-item" data-amount="{{  (($totalBalance /100) * 88) }}">
                        <input type="radio" class="invest-amount-control" name="iv-amount" id="iv-amount-6">
                        <label class="invest-amount-label" for="iv-amount-6">$ {{ number_format( (($totalBalance /100) * 88)) }}</label>
                    </div>
                    ...
                    <div class="dropdown invest-cc-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-auto dropdown-menu-mxh">
                            ...
                            @foreach ($wallets as $wallet)
                                <li class="invest-cc-item select-wallet" data-wallet="{{ ucfirst($wallet['currency']) }}"  data-walletId="{{ $wallet['id'] }}">
                                <div class="">
                ...
                <div class="invest-field form-group">
                    <div class="form-label-group">
                        <label class="form-label">Your <span class="selectedCurrency"></span> Wallet Address</label>
                    </div>
                    <div class="form-control-group">
                ...
                <div class="card card-bordered ms-lg-4 ms-xl-0">
                    ...
                    <div class="nk-iv-wg4-sub">
                        ...
                        <ul class="nk-iv-wg4-overview g-2">
                            ...
                            <li>
                                <div class="sub-text">Wallet</div>
                                <div class="lead-text" id="wallet-to-withdraw"></div>
                            </li>
                            <li>
                                <div class="sub-text">Wallet address</div>
                                <div class="lead-text" id="wallet-address-to-withdraw"></div>
                            </li>
                            <li>
...
<script>
    ...
    [...plan_selector].forEach((el) => {
        el.addEventListener('click', (e) => {
            ...
            document.querySelector('.selectedCurrency').textContent = e.currentTarget.dataset.wallet;
            document.querySelector('#wallet-to-withdraw').textContent = e.currentTarget.dataset.wallet;
    ...
    document.querySelector(".custom-wallet-input").addEventListener('input', (el) => {
        ...
        // console.log('b')
        document.querySelector("#wallet-address-to-withdraw").innerHTML = (wallet);
    })
