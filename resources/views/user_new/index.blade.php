            ...
            <div class="nk-content-body">
                <div class="nk-block-head">
                    <div class="nk-block-between-md g-3">
                        ...
                        <div class="nk-block-head-content d-none d-md-block" translate="no">
                        ...
                        {{-- <div class="col-md-12 col-lg-4">
                            <div class="nk-wg-card is-s3 card card-bordered">
                                <div class="card-inner">
                                    <div class="nk-iv-wg2">
                                        <div class="nk-iv-wg2-title">
                                            <h6 class="title">Total Interest <em class="icon ni ni-info"></em>
                                            </h6>
                                        </div>
                                        <div class="nk-iv-wg2-text">
                                            <div class="nk-iv-wg2-amount"> $ {{ number_format($user->deposit_interest, 2) }} <span class="change down">
                                                <span class="sign"></span>{{ number_format(((($user->deposit_interest) * 100)/($user->total_balance <= 0 ? 1 : $user->total_balance))) }}% </span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        {{-- <div class="col-md-12 col-lg-4">
                            <div class="nk-wg-card is-s3 card card-bordered">
                                <div class="card-inner">
                                    <div class="nk-iv-wg2">
                                        <div class="nk-iv-wg2-title">
                                            <h6 class="title">Total Referral Bonus <em class="icon ni ni-info"></em>
                                            </h6>
                                        </div>
                                        <div class="nk-iv-wg2-text">
                                            <div class="nk-iv-wg2-amount"> $ {{ number_format($user->referral_bonus, 2) }} <span class="change down">
                                                <span class="sign"></span>{{ number_format(((($user->referral_bonus) * 100)/($user->total_balance <= 0 ? 1 : $user->total_balance))) }}% </span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <ul class="nk-iv-wg2-list">
                                                ...
                                                <li>
                                                    <span class="item-label">
                                                        <a href="#">{{ ucfirst($investment->plan_name) }}</a>
                                                        <small>- {{ ucfirst($investment->plan_interest_rate) }}% for {{ ucfirst($investment->plan_duration) }} Days</small>
                                                    </span>
                            ...
                            <div class="nk-refwg-invite card-inner">
                                <div class="nk-refwg-head g-3">
                                    <div class="nk-refwg-title">
                                        ...
                                        <div class="title-sub">Use the below code to invite your friends.</div>
                                    </div>
