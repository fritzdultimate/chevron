            ...
            <div class="main_headline">
                ...
                <div class="text-center">
                    <h1 class="wow slideInUp undefined" style="visibility: visible; animation-name: slideInUp;">
                        Change Password chevronrefinery.net:
                    </h1>
                </div>
            </div>
                                    ...
                                    <div class="">
                                        <div class="boxmain">
                                            ...
                                            <div class="box-type w-100 w-full" style="width: 100%">
                                                ...
                                                <input required type="text" name="password" class="form-control" placeholder="Enter password" value="{{ old('password') }}" style="color: #efefef">
                                                @error('password')
                                                <div class="error">
                                                    <div class="alert_text">
                                                        {{ $message }}
                                            ...
                                            <div class="boxmain">
                                                ...
                                                <div class="box-type w-100 w-full" style="width: 100%">
                                                    ...
                                                    <input required type="text" name="repassword" class="form-control" placeholder="Repeat Password" value="{{ old('repassword') }}" style="color: #efefef">
