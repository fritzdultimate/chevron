        ...
        <div class="box6">
            <div class="main_headline">
                ...
                <div class="text-center">
                    <h1 class="wow slideInUp undefined" style="visibility: visible; animation-name: slideInUp;">FORGOT PASSWORD chevronrefinery.net:</h1>
                </div>
            </div>
                                    ...
                                    <div class="">
                                        <div class="boxmain">
                                            ...
                                            <div class="box-type w-100 w-full" style="width: 100%">
                                                <input type="text" name="email" placeholder="Email address" size="30" />
                                            </div>
                                        </div>
...
<script defer src="{{ asset('dash/js/fn.js') }}"></script>
<script defer src="{{ asset('dash/js/forgotpass.js') }}"></script>
