        ...
        <div class="box6">
            <div class="main_headline">
                ...
                <div class="text-center">
                    <h1 class="wow slideInUp undefined" style="visibility: visible; animation-name: slideInUp;">CREATE AN ACCOUNT chevronrefinery.net:</h1>
                </div>
            </div>
                ...
                <form class="page-form register-form" method="POST">
                    <div class="other-box">
                        <div style="margin-top: 0px;" class="other-boxone">
                            ...
                            <div class="box-downall">
                                <div class="box-downone">
                                    <div class="box-downleft">
                                        <div class="boxmain">
                                        ...
                                        <div class="boxmain">
                                            ...
                                            <div class="box-type">
                                                <input type="text" name="middlename" value="" size="30" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="box-downright">
                                        <div class="boxmain">
                                            <div class="box-tittle">
                                                <p>Username</p>
                                            </div>
                                        ...
                                        <div class="boxmain">
                                            ...
                                            <div class="box-type">
                                                <input required type="text" name="phone" value="" size="30" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="boxmain">
                                        ...
                                        <div class="box-type">
                                            <input type="text" pl name="uid" value="" size="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="other-boxone">
                            <div class="box-head">
                                <p><img src="images/favicon.png" /> Security Information</p>
                            </div>
                            <div class="box-downall">
                                <div class="box-downone">
                                    <div class="box-downleft">
                                    ...
                                    <div class="box-downright">
                                        <div class="boxmain">
                                            ...
                                            <div class="box-type">
                                                <input type="password" name="repassword" value="" size="30" />
                                                <input type="hidden" name="_token" value="9p4SFsbqeO3FcpdcNP1ird3bhLSLKM9rwwYqtxjv" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="sign-box">
                        <div class="check-text">
                            ...
                            <div class="agree">
                                <p>
                                    I Accept With <span><a href="/terms" style="color: #03a55e; text-decoration: none;"> Rules &amp; Agreement</a></span>
                                </p>
                            </div>
                        </div>
...
<script defer src="{{ asset('plugins/lobibox/js/lobibox.min.js') }}"></script>
<script defer src="{{ asset('dash/js/fn.js') }}?p=7"></script>
<script defer src="{{ asset('dash/js/register.js') }}?p=7"></script>
