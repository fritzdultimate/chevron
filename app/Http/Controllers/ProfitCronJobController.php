    ...
    public function addProfit() {
        ...
        foreach($deposits as $deposit) {
            if(isUpTo24Hours($deposit->updated_at)) {
                ...
                $interest_rate = $deposit->plan_interest_rate;
                ...
                ProfitCronJob::insert([
                    ...
                    'main_wallet_id' => $deposit->main_wallet_id,
                    'deposit_id' => $deposit->id,
                    // 'child_investment_plan_id' => $deposit->child_plan_id,
                ...
                $details = [
                    ...
                    'interest' => ((($deposit->amount)/100) * $deposit->plan_interest_rate) ,
                    'interest_rate' => $deposit->plan_interest_rate,
